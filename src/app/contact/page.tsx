      ...
      <section className="section bg-white">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            <FadeIn>
              {/* Address */}
              <div className="card p-6 sm:p-8 flex gap-5 sm:gap-6 items-start hover:border-[#06B6D4]/40 transition-colors">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#F0FDFE] rounded-xl flex items-center justify-center shrink-0">
                  <MapPin className="w-5 h-5 sm:w-6 sm:h-6 text-[#06B6D4]" />
                </div>
                <div>
            ...
            <FadeIn>
              ...
              <div className="card p-6 sm:p-8 flex gap-5 sm:gap-6 items-start hover:border-[#06B6D4]/40 transition-colors">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#F0FDFE] rounded-xl flex items-center justify-center shrink-0">
                  <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-[#06B6D4]" />
                </div>
                <div>
            ...
            <FadeIn>
              ...
              <div className="card p-6 sm:p-8 flex gap-5 sm:gap-6 items-start hover:border-[#06B6D4]/40 transition-colors">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#F0FDFE] rounded-xl flex items-center justify-center shrink-0">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-[#06B6D4]" />
                </div>
          ...
          <div className="lg:col-span-5">
            <FadeIn>
              <div className="p-6 sm:p-10 bg-[#0A0A0A] rounded-[2rem] flex flex-col gap-6 sm:gap-8 sticky top-32 shadow-xl ring-1 ring-white/10">
